    ...
    if (jarak < 0) {
      ...
      $(".start").click(function () {
        ...
        fire_modal(
          ...
          "Mari buat kue ulang tahun neyo!",
          "Karena ini ulang tahun neyo, pas kalau neyo buat kue ulang tahun secara digital sendiri. Untuk membuat kuenya, mulai dari mengaduk adonan kue yang kamu buat, panggang didalam oven dan terakhir silahkan neyo hias sesuai kemauan neyo. Sebelumnya selamat ulang tahun semoga neyo suka sama hadiahnya!"
        );
      });
